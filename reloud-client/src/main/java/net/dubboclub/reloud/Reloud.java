 ...
 * @version:1.0.0
 * @fix:
 * @description: redis客户端入口
 */
public class Reloud implements InitializingBean{

    private String zookeeperConnects;
    ...
    public void setZookeeperConnects(String zookeeperConnects) {
